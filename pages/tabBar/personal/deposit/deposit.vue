								  	 ...
								  	 uni.getStorage({
								  	 	...
								  	 	success : (ret)=>{
								  	 		this.request({
								  	 			...
								  	 			success :(ret)=>{
													console.log(ret)
													this.money = ret.result.money ? ret.result.money :  "0"
												},
								  	 			fail : (err)=>{
								  	 				uni.navigateTo({
								  	 					url: '../../login/login'
							...
							this.request({
								...
								data :{
									money : this.inputAmount,
									 way : this.paytype == 'alipay' ? 0 : 1 ,   // 支付宝0 微信1 
								},
								success :(ret)=>{
							      uni.hideLoading();
							      uni.showToast({
							      ...
							      setTimeout(()=>{
							      	uni.redirectTo({
							      		url: "../pay-success/pay-success?amount=" +  this.inputAmount
							      	});
							      },300);
						        },
								fail : (err)=>{
